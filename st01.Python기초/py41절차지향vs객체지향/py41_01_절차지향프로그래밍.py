...
def create_student(이름, 국어성적, 수학성적, 과학성적):
    return {
        "이름" : 이름, 
        "국어성적" : 국어성적, 
        "수학성적" : 수학성적, 
...
def stduent_get_sum(student):
    val = student["국어"] +student["수학"] +student["영어"] +student["과학"]
    return val

def student_get_average(student):
    val = stduent_get_sum(student)
    average = val / 4
    return average

def student_to_string(student):
    str = "이름 : %s, 국어 : %s, 수학 : %s, 영어 : %s, 과학 : %s" % (student["이름"], student["국어"], student["수학"], student["영어"], student["과학"])
    return str
